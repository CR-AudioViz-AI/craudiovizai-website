...
export default function SocialGraphicsApp() {
  ...
  const APP_URL = process.env.NEXT_PUBLIC_SOCIAL_GRAPHICS_URL || 'https://crav-social-graphics.vercel.app'
  const CREDIT_COST = 3
  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      ...
      if (!session) {
        router.push('/signin?redirect=/apps/social-graphics')
        return
      }
            ...
            if (!deductError) {
              await supabase
                ...
                .insert({
                  ...
                  amount: -CREDIT_COST,
                  app_name: 'Social Graphics',
                  description: 'Social media graphic generation',
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden sm:flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-lg font-semibold text-gray-900">Social Graphics Creator</h1>
                  <p className="text-sm text-gray-600">
                    {credits !== null ? `${credits} credits` : 'Loading...'} • {CREDIT_COST} per graphic
                  </p>
                </div>
              </div>
            </div>
      ...
      <main className="flex-1 relative bg-gray-100">
        {isLoading && (
          <div className="absolute inset-0 bg-white flex flex-col items-center justify-center z-10">
            ...
            <p className="text-gray-600 font-medium">Loading Social Graphics...</p>
          </div>
        )}
          ...
          <div className="absolute inset-0 bg-white flex items-center justify-center p-8 z-10">
            <Alert variant="destructive" className="max-w-md">
              ...
              <AlertDescription className="ml-2">
                <p className="font-semibold mb-2">Failed to load Social Graphics</p>
