...
export default function LogoStudioApp() {
  ...
  const APP_URL = process.env.NEXT_PUBLIC_LOGO_STUDIO_URL || 'https://crav-logo-studio.vercel.app'
  const CREDIT_COST = 6
  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      ...
      if (!session) {
        router.push('/signin?redirect=/apps/logo-studio')
        return
      }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden sm:flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-lg font-semibold text-gray-900">Logo Studio AI</h1>
                  <p className="text-sm text-gray-600">
                    {credits !== null ? `${credits} credits` : 'Loading...'} • {CREDIT_COST} per logo
                  </p>
                </div>
              </div>
            </div>
      ...
      <main className="flex-1 relative bg-gray-100">
        {isLoading && (
          <div className="absolute inset-0 bg-white flex flex-col items-center justify-center z-10">
            ...
            <p className="text-gray-600 font-medium">Loading Logo Studio...</p>
          </div>
        )}
          ...
          <div className="absolute inset-0 bg-white flex items-center justify-center p-8 z-10">
            <Alert variant="destructive" className="max-w-md">
              ...
              <AlertDescription className="ml-2">
                <p className="font-semibold mb-2">Failed to load Logo Studio</p>
