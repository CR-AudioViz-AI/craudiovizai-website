...
export default function InvoiceGeneratorApp() {
  ...
  const APP_URL = process.env.NEXT_PUBLIC_INVOICE_URL || 'https://crav-invoice-generator.vercel.app'
  const CREDIT_COST = 2
  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      ...
      if (!session) {
        router.push('/signin?redirect=/apps/invoice-generator')
        return
      }
              ...
              <div className="hidden sm:flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    {credits !== null ? `${credits} credits` : 'Loading...'} • {CREDIT_COST} per invoice
                  </p>
                </div>
              </div>
            </div>
      ...
      <main className="flex-1 relative bg-gray-100">
        {isLoading && (
          <div className="absolute inset-0 bg-white flex flex-col items-center justify-center z-10">
            ...
            <p className="text-gray-600 font-medium">Loading Invoice Generator...</p>
          </div>
        )}
          ...
          <div className="absolute inset-0 bg-white flex items-center justify-center p-8 z-10">
            <Alert variant="destructive" className="max-w-md">
              ...
              <AlertDescription className="ml-2">
                <p className="font-semibold mb-2">Failed to load Invoice Generator</p>
