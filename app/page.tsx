        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {/* Facebook */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#1877F2] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <Facebook className="w-4 h-4" />
                Facebook
              </a>
              
              {/* Instagram */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <Instagram className="w-4 h-4" />
                Instagram
              </a>
              
              {/* LinkedIn */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#0A66C2] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <Linkedin className="w-4 h-4" />
                LinkedIn
              </a>
              
              {/* YouTube */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#FF0000] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <Youtube className="w-4 h-4" />
                YouTube
              </a>
              
              {/* Twitter/X */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-black text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
              ...
              {/* GitHub */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#181717] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <Github className="w-4 h-4" />
                GitHub
              </a>
              
              {/* Discord */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#5865F2] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <MessageSquare className="w-4 h-4" />
                Discord
              </a>
              
              {/* Twitch */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#9146FF] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <Twitch className="w-4 h-4" />
                Twitch
              </a>
              
              {/* Reddit */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#FF4500] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Pinterest */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#E60023] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Snapchat */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#FFFC00] text-black rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Telegram */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#26A5E4] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* WhatsApp */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#25D366] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Slack */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#4A154B] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Quora */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#B92B27] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Product Hunt */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#DA552F] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Behance */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#1769FF] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Glassdoor */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#0CAA41] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Indeed */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#003A9B] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Tumblr */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#35465C] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Clubhouse */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#F2C94C] text-black rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Substack */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#FF6719] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <Mail className="w-4 h-4" />
                Substack
              </a>
              
              {/* Newsletter */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-gray-700 text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <Mail className="w-4 h-4" />
                Newsletter
              </a>
              
              {/* Google Business */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-[#4285F4] text-white rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Lemonde */}
              <a href="#" className="inline-flex items-center gap-2 px-4 py-2 bg-yellow-400 text-gray-900 rounded-full text-sm font-semibold hover:opacity-80 transition">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
