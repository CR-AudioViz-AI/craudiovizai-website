...
import { Check, X, Sparkles, Zap, Crown, HelpCircle, DollarSign, Clock } from 'lucide-react';
            ...
            <Card className="border-4 border-blue-500 shadow-2xl relative">
              ...
              <CardContent>
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700 font-semibold">Roll over indefinitely</span>
                  </li>
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="text-gray-600">
                  Free plan credits expire monthly. Pro and Professional plan credits NEVER expire and roll over indefinitely as long as your plan is active. If your plan expires, you have 10 days to renew and keep all your credits.
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">What is the 10-day grace period?</CardTitle>
                </CardHeader>
                <CardContent className="text-gray-600">
                  If your paid plan expires (after cancellation or failed payment), you have 10 days to renew and preserve all your accumulated credits. After 10 days without renewal, all credits are forfeited.
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="text-gray-600">
                  We offer a 14-day money-back guarantee on initial subscriptions, but ONLY if you haven't used any credits or accessed any paid features. See our{' '}
                  <Link href="/payment-services" className="text-blue-600 hover:text-blue-700 underline">
                    Payment Services
                  </Link>{' '}
                  page for full refund policy details.
                </CardContent>
              </Card>
