                ...
                return (
                  <Card key={program.name} className="hover:shadow-lg transition-all">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <p className="text-xl md:text-2xl font-bold text-green-600 mb-2">{program.amount}</p>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
            <Link href="/contact?subject=Grant Application" className="flex-1">
              <MobileButton size="lg" fullWidth className="bg-white text-green-600 hover:bg-green-50">
                Apply Now
              </MobileButton>
            </Link>
